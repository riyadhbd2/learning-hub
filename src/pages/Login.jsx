        ...
        <div className="container mx-auto flex justify-center mt-52 border border-blue-500 w-52">
            ...
            <form onSubmit={handleLogIn}>
                ...
                <div className="text-center pb-4 mt-2">
                    <button className="text-white bg-blue-500 rounded-lg p-1 text-sm" type="submit">Email</button>
                </div>
                <div className='border border-green-400 mb-3 p-1 font-sixe'>
                    <p className='flex justify-center text-sm'>Use one of these options </p>
                    <div className='flex justify-evenly mb-2 mt-2'>
                        <div className='flex items-center p-2'>
                            <button onClick={handleGoogleLogin} className='bg-yellow-500 text-white p-1 rounded-lg'>Google</button>
                        </div>
                        <div className='flex items-center p-2'>
                            <button className='bg-yellow-500 text-white p-1 rounded-lg'>Github</button>
                        </div>
                    </div>
